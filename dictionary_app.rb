...
example_response = HTTP.get("https://api.wordnik.com/v4/word.json/banana/examples?includeDuplicates=false&useCanonical=false&limit=5&api_key=7rzrusqms9ysbvd11ihq7idgk3slkzghxnqc6k6rmn3520mq9")

p definition_response.parse[0]["text"]
p example_response.parse["examples"][0]